...
export class LabelerServer {
    ...
    constructor(options) {
        ...
        if (options.dbUrl) {
            if (!options.dbToken) {
                throw new Error("The `dbToken` option is required when using a remote database URL.");
            }
    ...
    async createLabel(label) {
        return await this.saveLabel(excludeNullish({
            ...label,
     ...
     */
    async createLabels(subject, labels) {
        await this.dbInitLock;
