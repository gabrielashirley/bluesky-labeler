...
declare module '@atcute/client/lexicons' {
    ...
    namespace ToolsOzoneModerationDefs {
        ...
        interface AccountEvent {
            ...
            timestamp: string;
            comment?: string;
            status?: 'deactivated' | 'deleted' | 'suspended' | 'takendown' | 'tombstoned' | 'unknown' | (string & {});
        }
        ...
        interface ModEventView {
            ...
            createdAt: string;
            createdBy: At.DID;
            event: Brand.Union<AccountEvent | IdentityEvent | ModEventAcknowledge | ModEventComment | ModEventDivert | ModEventEmail | ModEventEscalate | ModEventLabel | ModEventMute | ModEventMuteReporter | ModEventPriorityScore | ModEventReport | ModEventResolveAppeal | ModEventReverseTakedown | ModEventTag | ModEventTakedown | ModEventUnmute | ModEventUnmuteReporter | RecordEvent>;
            id: number;
            subject: Brand.Union<ChatBskyConvoDefs.MessageRef | ComAtprotoAdminDefs.RepoRef | ComAtprotoRepoStrongRef.Main>;
        ...
        type SubjectReviewState = '#reviewClosed' | '#reviewEscalated' | '#reviewNone' | '#reviewOpen' | (string & {});
    ...
    namespace ToolsOzoneModerationEmitEvent {
        ...
        interface Input {
            createdBy: At.DID;
            event: Brand.Union<ToolsOzoneModerationDefs.AccountEvent | ToolsOzoneModerationDefs.IdentityEvent | ToolsOzoneModerationDefs.ModEventAcknowledge | ToolsOzoneModerationDefs.ModEventComment | ToolsOzoneModerationDefs.ModEventDivert | ToolsOzoneModerationDefs.ModEventEmail | ToolsOzoneModerationDefs.ModEventEscalate | ToolsOzoneModerationDefs.ModEventLabel | ToolsOzoneModerationDefs.ModEventMute | ToolsOzoneModerationDefs.ModEventMuteReporter | ToolsOzoneModerationDefs.ModEventPriorityScore | ToolsOzoneModerationDefs.ModEventReport | ToolsOzoneModerationDefs.ModEventResolveAppeal | ToolsOzoneModerationDefs.ModEventReverseTakedown | ToolsOzoneModerationDefs.ModEventTag | ToolsOzoneModerationDefs.ModEventTakedown | ToolsOzoneModerationDefs.ModEventUnmute | ToolsOzoneModerationDefs.ModEventUnmuteReporter | ToolsOzoneModerationDefs.RecordEvent>;
            subject: Brand.Union<ComAtprotoAdminDefs.RepoRef | ComAtprotoRepoStrongRef.Main>;
            subjectBlobCids?: At.CID[];
        }
    ...
    namespace ToolsOzoneModerationGetRecords {
        ...
        type Input = undefined;
        interface Output {
            records: Brand.Union<ToolsOzoneModerationDefs.RecordViewDetail | ToolsOzoneModerationDefs.RecordViewNotFound>[];
        }
    }
    ...
    namespace ToolsOzoneModerationGetRepos {
        ...
        type Input = undefined;
        interface Output {
            repos: Brand.Union<ToolsOzoneModerationDefs.RepoViewDetail | ToolsOzoneModerationDefs.RepoViewNotFound>[];
        }
    }
    ...
    namespace ToolsOzoneSettingDefs {
        interface Option {
             ...
             */
            description?: string;
            managerRole?: 'tools.ozone.team.defs#roleAdmin' | 'tools.ozone.team.defs#roleModerator' | 'tools.ozone.team.defs#roleTriage' | (string & {});
            updatedAt?: string;
        }
    }
