...
export declare namespace ComAtprotoAdminGetSubjectStatus {
    ...
    type Input = undefined;
    interface Output {
        subject: Brand.Union<ComAtprotoAdminDefs.RepoBlobRef | ComAtprotoAdminDefs.RepoRef | ComAtprotoRepoStrongRef.Main>;
...
export declare namespace ComAtprotoLabelDefs {
    ...
    type LabelValue = '!hide' | '!no-promote' | '!no-unauthenticated' | '!warn' | 'dmca-violation' | 'doxxing' | 'gore' | 'nsfl' | 'nudity' | 'porn' | 'sexual' | (string & {});
